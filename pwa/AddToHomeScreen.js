...
const AddToIosSafari = dynamic(() => import("./AddToMobileChromeIos"), {
  loading: () => <ModuleLoading />,
});
const AddToMobileChrome = dynamic(() => import("./AddToMobileChrome"), {
  loading: () => <ModuleLoading />,
});
// const AddToMobileFirefox = dynamic(() => import("./AddToMobileChrome"), {
//   loading: () => <ModuleLoading />,
// });
// const AddToMobileFirefoxIos = dynamic(() => import("./AddToMobileChrome"), {
//   loading: () => <ModuleLoading />,
// });
const AddToMobileChromeIos = dynamic(() => import("./AddToMobileChromeIos"), {
  loading: () => <ModuleLoading />,
});
// const AddToSamsung = dynamic(() => import("./AddToMobileChrome"), {
//   loading: () => <ModuleLoading />,
// });
// const AddToOtherBrowser = dynamic(() => import("./AddToMobileChrome"), {
//   loading: () => <ModuleLoading />,
// });
